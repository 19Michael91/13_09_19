...
@section('admin-content')
	...
	<div>
		<h1>Edit  User</h1>
		<br/>
		<form class="form-horizontal"  enctype="multipart/form-data" role="form" method="POST" action="{{ route('admin.users.update') }}">
            ...
            <div class="form-group" >
				...
				<div class="col-sm-10">
					<select  class="form-control" id="status" name="status">
						<option @if (\App\User::STATUS_NOT_ACTIVE == $user->status) selected @endif value="0">Not Active</option>
						<option @if (\App\User::STATUS_ACTIVE == $user->status) selected @endif value="1">Active</option>
					</select>
